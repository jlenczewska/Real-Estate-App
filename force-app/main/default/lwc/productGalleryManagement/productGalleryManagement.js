...
import editShouldBeAvailable from "@salesforce/apex/RE_filePreviewAndDownloadController.editShouldBeAvailable";
import getDisplayImage from "@salesforce/apex/RE_filePreviewAndDownloadController.getDisplayImage";
...
export default class ProductGalleryManagement extends NavigationMixin(LightningElement) {
  selected;
  selectedElementId;
  enableButtons = false;
  filesList = [];
  ...
  connectedCallback(){
    this.userEnabledToEdit = editShouldBeAvailable();
  }
